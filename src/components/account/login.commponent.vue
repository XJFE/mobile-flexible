...
<template>
    <div class="mark" v-if="isShow">
        <div class="container login">
            ...
            <p class="username"><input v-model="username" type="text" placeholder="请输入登录的手机号" maxlength="20" autofocus></p>
            <p class="password last"><input v-model="password" type="password" placeholder="请输入密码" maxlength="20"></p>
            <p class="btnLogin"><input type="button" :class="{disabled: disabled}" value="登录" @click.stop="login"></p>
            <p class="clearfix">
